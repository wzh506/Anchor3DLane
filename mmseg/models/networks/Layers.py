...
from mmseg.models.utils.ops.modules import MSDeformAttn, IdentityMSDeformAttn, DropoutMSDeformAttn
...
class EncoderLayer(nn.Module):
    ...
    def forward(self,
        ...
        # cross attention
        query = self.cross_attn(query, #torch.Size([8, 26624, 64])
                                reference_points=ref_3d,#torch.Size([8, 26624, 1, 2])
                                input_flatten=value, #torch.Size([8, 10800, 64]) 不只是通道，feature的尺度也变小了
