...
from mmcv.runner import (get_dist_info, init_dist, load_checkpoint, HOOKS,
                         wrap_fp16_model, DistSamplerSeedHook, build_runner, EpochBasedRunner,
...
from mmseg.utils import (build_ddp, build_dp, get_device, find_latest_checkpoint,
...
def parse_args():
    ...
    group_gpus.add_argument(
        ...
        '(only applicable to non-distributed training)')
    parser.add_argument('--seed', type=int, default=None, help='random seed')  #2048579029
    parser.add_argument(
        '--diff_seed',
        action='store_true',
